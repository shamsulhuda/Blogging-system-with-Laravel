...
<footer class="footer" id="site-footer">
    <div class="container">
            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        <h3 class="heading-title" >{{ ucfirst($settings->site_name) }}</h3>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            ...
                            <p class="sub-title">Hatibandha, Lalmonirhat</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <p class="text-center"> <i class="fa fa-copyright"></i> Copyright-{{date('Y')}} | <a href="{{asset('/')}}">{{ucfirst($settings->site_name) }}</a></p>
        </div>
